...
CREATE TABLE IF NOT EXISTS proveedores (
  ...
  rtn               VARCHAR(20)      NULL,
  cuenta_proveedor  VARCHAR(150)     NULL    COMMENT 'Número de cuenta bancaria del proveedor',
  tipos_pago        VARCHAR(300)     NULL    COMMENT 'Tipos de pago aceptados, separados por coma',
