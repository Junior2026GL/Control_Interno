...
import ViaticosNacionales from './pages/ViaticosNacionales';
      ...
      <AuthProvider>
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/viaticos-nacionales" element={<ModuleRoute modulo="viaticos-nacionales"><ViaticosNacionales /></ModuleRoute>} />
