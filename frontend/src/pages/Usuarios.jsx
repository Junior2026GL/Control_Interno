...
const MODULOS_LABELS = {
  ...
  'diputados':               'Diputados',
  'viaticos':                'Viáticos',
  'viaticos-diputados':      'Viáticos Diputados',
  'reportes-presupuesto':    'Reportes Presupuesto',
  'presupuesto':             'Presupuesto Social',
  'presupuesto-social':      'Presupuesto Social',
  'busqueda-ayudas':         'Consulta de Ayudas',
  'constancia-transferencia':'Constancia Transferencia',
  'bodegas':                 'Entrega de Canastas',
  'fardos-confites':         'Entrega de Fardos de Confites',
  'ayudas':                  'Ayudas',
  'ayudas_alcaldias':        'Ayudas Alcaldías',
  'mapa-alcaldias':          'Mapa Alcaldías',
  'alcaldes':                'Alcaldes Municipales',
  'proveedores':             'Base de Datos Proveedores',
  'checklist':               'Check List Expedientes',
  'orden-checklist':         'Órdenes de Checklist',
