...
function clientValidate(form) {
  ...
  if (!persona) errors.persona_retiro = 'La persona que recogió los fardos es requerida.';
...
export default function FardosConfites() {
  ...
  const fetchRegistros = useCallback(async () => {
    setLoading(true);
    try {
      const res = await api.get('/fardos-confites', { headers: authHeaders() });
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      if (editing) {
        await api.put(`/fardos-confites/${editing}`, payload, { headers: authHeaders() });
        showToast('Registro actualizado correctamente.', 'ok');
      } else {
        await api.post('/fardos-confites', payload, { headers: authHeaders() });
  ...
  const handleDelete = async () => {
    ...
    setDeleting(true);
    try {
      await api.delete(`/fardos-confites/${confirmDel.id}`, { headers: authHeaders() });
  ...
  const exportPDF = async () => {
    ...
    doc.save(`entrega_fardos_confites_${now.toISOString().slice(0, 10)}.pdf`);
  };
      ...
      <div className="bod-container">
        ...
        <div className="bod-page-header">
          <div className="bod-page-header__left">
            ...
            <div>
              <h1 className="bod-page-title">Entrega de Fardos de Confites</h1>
              <p className="bod-page-sub">Actividad del Día del Niño — Registro por diputado responsable</p>
            </div>
          </div>
        ...
        <div className="bod-stats">
          ...
          <div className="bod-stat">
            ...
            <div className="bod-stat__body">
              <span className="bod-stat__label">Total Fardos Entregados</span>
        ...
        {showPartidoStats && (
          <div className="bod-depto-panel">
            <div className="bod-depto-panel__header">
              <FiBarChart2 size={16} />
              <span>Fardos entregados por Partido Político</span>
        ...
        {showStats && (
          <div className="bod-depto-panel">
            <div className="bod-depto-panel__header">
              <FiBarChart2 size={16} />
              <span>Fardos entregados por Departamento</span>
              ...
              <table className="bod-table">
                <thead>
                  <tr>
                    ...
                    <th>Persona que Recogió</th>
                    <th>Departamento</th>
                    <th>Partido Político</th>
                    <th>Fecha de Entrega</th>
                    <th className="bod-th-center">Cant. Fardos</th>
              ...
              <div className="bod-view-body">
                ...
                <div className="bod-view-grid">
                  <div className="bod-view-field">
                    <span className="bod-view-label">Persona que Recogió</span>
                  ...
                  <div className="bod-view-field">
                    <span className="bod-view-label">Cantidad de Fardos</span>
            ...
            <div className="bod-modal">
              ...
              <form className="bod-modal__body" onSubmit={handleSave} noValidate>
                ...
                <div className="bod-field bod-field--full">
                  <label className="bod-label">Persona que Recogió los Fardos *</label>
                  <input className={`bod-input ${formErrors.persona_retiro ? 'bod-input--error' : ''}`} name="persona_retiro" value={form.persona_retiro} onChange={handleField} placeholder="Nombre completo de quien recogió los fardos" />
                ...
                <div className="bod-field">
                  <label className="bod-label">Cant. de Fardos *</label>
